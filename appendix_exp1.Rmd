...
# # Create the table
kbl(conspiracy_measures, booktabs = T, longtable = T,
    caption = "Conspiracy measures", full_width = T) %>%
  kable_styling(font_size = 8) %>% 
  column_spec(1, width = "10em") %>%
  column_spec(2, width = "20em") %>%
  column_spec(3, width = "10em")

# Use apa_table to format the table
# apa_table(
#   conspiracy_measures,
#   caption = "Overview of Conspiracy Thinking Measures",
#   align = c("m{4cm}", "m{10cm}", "m{4cm}")
# )
```
