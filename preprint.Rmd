...
shorttitle        : "Quasi-universal acceptance of basic science in the US"
...
authornote: |
  Jan Pfänder is a PhD candidate in psychology, working on misinformation and trust in science. 
  Lou Kerzreho is a Master’s student in cognitive science.
  Hugo Mercier is a research director at the CNRS, whose work has focused on two main topics: the function and workings of reasoning, and how we evaluate communicated information.
...
Data for all experiments and the simulations is available on the OSF project page (https://osf.io/8utsj/). 
