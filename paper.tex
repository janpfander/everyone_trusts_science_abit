...
\urlstyle{same}
\hypersetup{
  pdftitle={Universal acceptance of (nearly all of) basic science in the US},
  pdflang={en-EN},
  hidelinks,
...
\paragraph{Trust in science}\label{trust-in-science-1}
...
\begin{longtable}[t]{>{}r>{\raggedright\arraybackslash}p{40em}}
\caption{\label{tab:unnamed-chunk-21}Reasons for consensus rejection}\\
\toprule
id & comments\\
\midrule
1 & no\\
